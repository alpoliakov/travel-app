    ...
    sightList: [
      ...
      },
      {
        ...
        description: {
          ...
          uk:
            'Собор Санта-Марія-дель-Фйоре - кафедральний собор у Флоренції, найвідоміше з архітектурних споруд флорентійського кватроченто. Знаходиться в центрі міста, на Соборній площі.',
          en:
